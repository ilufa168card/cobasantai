...
// function change(){
        ...
        if(strpos($code1, 'GoFood 20k & 10k udh jd milikmu boss')){
        ...
        if(strpos($boba10, 'GoFood 15k & 10k udh jd milikmu boss.')){
